...
async def _build_full_round(db, row: RoundORM, owner_id: str) -> Round:
    ...
    return Round(
        ...
        courseLat=row.course_lat,
        courseLng=row.course_lng,
        mappedCourseId=row.mapped_course_id,
        teeId=row.tee_id,
...
async def create_round(
    ...
    async with async_session() as db:
        ...
        round_row = RoundORM(
            ...
            course_lat=data.courseLat,
            course_lng=data.courseLng,
            mapped_course_id=data.mappedCourseId,
            tee_id=data.teeId,
