...
# Conservative ALLOWLIST of model-id prefixes known to accept `temperature`
# alongside `tools` (some newer models 400 on that combination). Unknown /
# future model ids fail SAFE by omitting temperature, never a 400.
