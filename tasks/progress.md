...
- Builder DONE @ d522d93 (fixes in 5af0315): 86/86 targeted + 1884 broader pass local, ruff clean, uv sync/import ok, zero frontend files. AWAITING reviewer(a4aa1365) + QA(add3134a) on d522d93. On results → fold BLOCKING (re-dispatch builder), else open fresh bundle PR to main + update checklist/backlog(s3b→shipped)/progress. NO ship/NO ping. If I die: reviewer+QA already dispatched on d522d93 — reconcile origin/integration/next, do NOT rebuild builder work.
