...
- AWAITING: designer sign-off screenshot on the BUILT orb (paper). SIGN-OFF → update PR #133 checklist + backlog orb-s5 + this log as DONE. CHANGES-NEEDED → re-dispatch builder on CaddieOrb.tsx (rebase-before-push), re-review.
